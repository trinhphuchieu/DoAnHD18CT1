...
# Dinh nghia class
# class_name = ['0000','10000','20000','50000','100000','200000','500000']
...
my_model = get_model()
my_model.load_weights("weights-45-0.99.hdf5")
...
while(True):
    ...
    if (np.max(predict)>=0.8) and (np.argmax(predict[0])!=0):
        ...
        cv2.putText(image_org, class_name[np.argmax(predict)] + " " + str(np.max(predict) * 100), org, font,
...
# Ket thuc qua trinh test nhan dien bang camera
cap.release()
